...
public class Generate_disks : MonoBehaviour
{
    ...
    public void generate_disks()
    {
        ...
        for (int i = 0; i < positions_disks.Length; i++)
        {
            ...
            {
                positions_disks[i + 1] = new Vector3(positions_disks[i].x, positions_disks[i].y + 0.03f, positions_disks[i].z);
    ...
    public void generate_towers()
    {
        ...
        for (int i = 0; i < positions_towers.Length; i++)
        {
            ...
            {
                positions_towers[i + 1] = new Vector3(positions_towers[i].x + direction_generation.x, positions_towers[i].y + direction_generation.y, positions_towers[i].z + direction_generation.z);
            }
